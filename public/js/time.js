...
window.addEventListener("load", function (_) {
    ...
    new Canvas(new CanvasLine(0.6, 230, [0, 110, 45, 110, 10, 5, 70, 0, 10], 5, 25, true, "#ffffff"));
    new Canvas(new CanvasLine(0.4, 210, [0, 90, 100, 110, 50], 3, 16, false, "#ffffff"));
    new Canvas(new CanvasLine(0.3, 190, [0, 30, 5, 3, 60, 130, 5, 3, 90, 34], 5, 20, true, "#ffffff"));
    new Canvas(new CanvasLine(0.5, 180, [30, 80, 110, 80, 40, 20], 3, 18, false, "#ffffff"));
    new Canvas(new CanvasLine(0.7, 130, [0, 60, 30, 130, 45, 95], 10, 15, true, "#ffffff"));
    new Canvas(new CanvasLine(0.5, 110, [0, 30, 230, 100], 3, 6, false, "#ffffff"));
    new Canvas(new CanvasLine(0.6, 100, [130, 120, 110], 3, 4, true, "#ffffff"));
    new Canvas(new CanvasLine(1, 60, [0, angel, 6, 354 - angel], 3, 0, true, "#ffffff")).canvas.setAttribute("class", "rotate");
